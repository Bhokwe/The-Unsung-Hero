...
## AI Tools & Task List
- **Coding (Cursor):** Generating the Knight's "Reckless" State Machine and player movement.
...
- **Documentation (ChatGPT/Gemini):** Assisting in refining the AI Ethics Statement.
